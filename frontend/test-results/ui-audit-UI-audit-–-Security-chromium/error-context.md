...
- Name: ui-audit.test.ts >> UI audit – Security
- Location: ui-audit.test.ts:12:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8080/security
Call log:
  - navigating to "http://localhost:8080/security", waiting until "load"
