...
import {StatCard} from '@/entities/portfolio/ui/StatCard';
import {AccountGrid} from '@/entities/portfolio/ui/AccountGrid';
...
export const PortfolioSummary: React.FC = () => {
    const {user, token, accountInfo, userAccounts, loading, currentChainId, deploySmartAccount, createSmartAccount} = useBackendSmartAccount();
    ...
    const handleCreateAccount = async () => {
        try {
            await createSmartAccount(currentChainId);
        } catch (error) {
